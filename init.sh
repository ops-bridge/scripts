...
EOF
        ...
        "Deploy OpsBridge")
            ...
            bash ./get-helm-3 
            helm version 
            export GH="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"
            echo $GH | helm repo add opsbridge --username ops-bridge https://raw.githubusercontent.com/ops-bridge/appcatalog/main/charts/
            helm repo update

...
EOF
        ...
        "Deploy OpsBridge")
            ...
            bash ./get-helm-3 
            helm version 
            echo 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 | helm repo add opsbridge --username ops-bridge https://raw.githubusercontent.com/ops-bridge/appcatalog/main/charts/
            helm repo update
